...
- Case-insensitive fuzzy file search with `/`, space-separated terms that all match in any order, Tab to cycle matches, and Enter to open files through `xdg-open`.
